...
//   // We keep the UI metadata here, but we'll merge it with live data
//   const categoryUI = {
...
//         const res = await axios.get('http://localhost:4000/api/news/stats', {
...
//             // Find the live count from our stats array
...
import React, { useState, useEffect } from 'react';
import { Link } from 'react-router-dom';
// 1. Import the function from your api.js
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        // 3. Use the imported API function
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        {/* 4. Optional: Add a simple loading spinner or skeleton logic here */}
        {loading ? (
